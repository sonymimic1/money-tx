...
func (m *MockStore) CreateAccount(ctx context.Context, arg db.CreateAccountParams) (sql.Result, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateEntry(ctx context.Context, arg db.CreateEntryParams) (sql.Result, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateTransfer(ctx context.Context, arg db.CreateTransferParams) (sql.Result, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) DeleteAccount(ctx context.Context, id uint64) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAccount(ctx context.Context, id uint64) (db.Account, error) {
	m.ctrl.T.Helper()
